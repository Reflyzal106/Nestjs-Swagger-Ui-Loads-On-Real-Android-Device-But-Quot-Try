# [SOLVED] Nestjs-Swagger-Ui-Loads-On-Real-Android-Device-But-Quot-Try
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/nestjs-swagger-ui-loads-on-real-android-device-but-quot-try)
>
...
Check if the Android device is connected to the same Wi-Fi network as the MacBook and update the backend IP address in the Swagger UI configuration to use the device's IP address instead of the MacBook's.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/nestjs-swagger-ui-loads-on-real-android-device-but-quot-try)**
